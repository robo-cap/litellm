"""
Calling + translation logic for OCI's chat endpoint
"""
...
async def make_call(
    ...
    try:
        ...
        raise OCIGenAIError(
            ...
            message=(await e.response.aread()).decode("utf-8"),
        ...
        for exception in litellm.LITELLM_EXCEPTION_TYPES:
            if isinstance(e, exception):
                raise e
        raise OCIGenAIError(status_code=500, message=str(e))
...
def make_sync_call(
    ...
    try:
        ...
        raise OCIGenAIError(
            status_code=e.response.status_code,
            message=e.response.read().decode("utf-8"),
            headers=error_headers,
        )
    except Exception as e:
        for exception in litellm.LITELLM_EXCEPTION_TYPES:
